...
def _clean_review_date_string(date_string):
    ...
    Args:
        date_string: A Review.review date string.
...
def convert_review_string_to_date(date_string):
    """
    Converts Review_set.data in string format to date object:
    ...
    date_string_formatted = _clean_review_date_string(date_string)
