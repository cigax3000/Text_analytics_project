...
def remove_stopwords(text):
    ...
    stop_set.update(['amp','would','one','get','make','use','really',
                     'go','think','first','old','new','put','two','even','look','come','year','also',
                     'time','give','quotation','work','say','could','take','back','want','find','new','try',
                     'money','fill','hear','big','want','know','thing','see','seem','day','another','month'])
